...
class _SavingsEndpoints():
    ...
    set_set_lending_rate = ['/api/v5/finance/savings/set-lending-rate', 'POST']  # POST / 设置余币宝借贷利率
...
class Savings(Client):
    ...
    # POST / 设置余币宝借贷利率
    def set_set_lending_rate(self, ccy: str, rate: str, proxies={}, proxy_host: str = None):
        '''
        ...
        rate              	String  	贷出年利率
        '''
        return self.send_request(*_SavingsEndpoints.set_set_lending_rate, **to_local(locals()))
