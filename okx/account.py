...
class _AccountEndpoints():
    ...
    set_set_auto_loan = ['/api/v5/account/set-auto-loan', 'POST']  # 设置自动借币
    set_set_account_level = ['/api/v5/account/set-account-level', 'POST']  # 设置账户模式
...
class Account(Client):
    ...
    # 设置持仓模式
    def set_set_position_mode(self, posMode: str, proxies={}, proxy_host: str = None):
        '''
    ...
    # 设置杠杆倍数
    def set_set_leverage(self, lever: str, mgnMode: str, instId: str = '', ccy: str = '', posSide: str = '', proxies={},
                         proxy_host: str = None):
        '''
    ...
    # 期权greeks的PA/BS切换
    def set_set_greeks(self, greeksType: str, proxies={}, proxy_host: str = None):
        '''
        设置greeks的展示方式。
    ...
    # 逐仓交易设置
    def set_set_isolated_mode(self, isoMode: str, type: str, proxies={}, proxy_host: str = None):
        '''
    ...
    # 设置组合保证金账户风险对冲模式
    def set_set_riskOffset_type(self, type: str, proxies={}, proxy_host: str = None):
        '''
    ...
    # 设置自动借币
    def set_set_auto_loan(self, autoLoan: bool = '', proxies={}, proxy_host: str = None):
        '''
        ...
        '''
        return self.send_request(*_AccountEndpoints.set_set_auto_loan, **to_local(locals()))

    # 设置账户模式
    def set_set_account_level(self, acctLv: str, proxies={}, proxy_host: str = None):
        '''
        ...
        acctLv            	String  	账户模式
        '''
        return self.send_request(*_AccountEndpoints.set_set_account_level, **to_local(locals()))
