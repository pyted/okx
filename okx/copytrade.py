...
class _CopyTradeEndpoints():
    ...
    set_set_instruments = ['/api/v5/copytrading/set-instruments', 'POST']  # POST / 交易员修改带单合约
...
class CopyTrade(Client):
    ...
    # POST / 交易员修改带单合约
    def set_set_instruments(self, instId: str, proxies={}, proxy_host: str = None):
        '''
        ...
        '''
        return self.send_request(*_CopyTradeEndpoints.set_set_instruments, **to_local(locals()))
