...
class Trade(Client):
    ...
    def set_batch_orders(self, instId: str, tdMode: str, side: str, ordType: str, sz: str, ccy: str = '',
                         clOrdId: str = '', tag: str = '', posSide: str = '', px: str = '', pxUsd: str = '',
                         pxVol: str = '', reduceOnly: bool = '', tgtCcy: str = '', banAmend: bool = '',
                         attachAlgoClOrdId: str = '', tpTriggerPx: str = '', tpOrdPx: str = '', slTriggerPx: str = '',
                         slOrdPx: str = '', stpId: str = '', stpMode: str = '', tpTriggerPxType: str = '',
                         slTriggerPxType: str = '', quickMgnType: str = '', proxies={}, proxy_host: str = None):
        '''
    ...
    # POST / 批量撤单
    def set_cancel_batch_orders(self, instId: str, ordId: str = '', clOrdId: str = '', proxies={},
                                proxy_host: str = None):
        '''
    ...
    def set_amend_batch_orders(self, instId: str, cxlOnFail: bool = '', ordId: str = '', clOrdId: str = '',
                               reqId: str = '', newSz: str = '', newPx: str = '', newPxUsd: str = '',
                               newPxVol: str = '', newTpTriggerPx: str = '', newTpOrdPx: str = '',
