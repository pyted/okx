...
class _SubAccountEndpoints():
    ...
    set_set_loan_allocation = ['/api/v5/account/subaccount/set-loan-allocation', 'POST']  # 设置子账户尊享借币比率
...
class SubAccount(Client):
    ...
    # 设置子账户主动转出权限
    def set_set_transfer_out(self, subAcct: str, canTransOut: bool = '', proxies={}, proxy_host: str = None):
        '''
    ...
    # 设置子账户尊享借币比率
    def set_set_loan_allocation(self, enable: bool, alloc: object = '', proxies={}, proxy_host: str = None):
        '''
        ...
        '''
        return self.send_request(*_SubAccountEndpoints.set_set_loan_allocation, **to_local(locals()))
